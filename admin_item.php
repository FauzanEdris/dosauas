        	...
        	<div class="row">
                ...
                <div class="col-md-3" style="margin-bottom: 50px;">
                    <div class="item-container">
                        ...
                        <tr align="right">
                            <td><a href="edit_item.php?id=<?php echo $item['id'] ?>">Edit</a>
                            <a href="delete_item.php?id=<?php echo $item['id'] ?>">Delete</a></td>
                        </tr>
                    </table>
                    </div>
                </div>
     	 ...
     	 <?php 
                            ...
                            if(!$conn){
                                ...
                                if($_SERVER["REQUEST_METHOD"] == "POST"){
                                    ...
                                    $sql_cek = "select * from item where nama='$nama'";
                                    ...
                                    if(!$cek_result){
                                        ...
                                        if($cek_result->num_rows > 0){
                                            ...
                                            $sql_insert = "insert into item(nama,harga,image) values('$nama','$harga','$filename')";
                                        
                                            if(!$conn->query($sql_insert)){
                                                echo "Errormessage: %s\n", $conn->error;
                                            }
                                            else{
                                                echo "<script>alert('data tersimpan!');location.href='admin_item.php';</script>";
                                            }
                                        }
                                    }
                                }
