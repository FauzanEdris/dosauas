        	...
        	<div class="row">
                ...
                <div class="col-md-3">
                    <div class="item-container">
                        ...
                        <tr align="right">
                            <td><a href="edit_baju.php?id=<?php echo $item['id'] ?>">Edit</a>
                            <a href="delete_baju.php?id=<?php echo $item['id'] ?>">Delete</a></td>
                        </tr>
                    </table>
                    </div>
                </div>
                                ...
                                if($_SERVER["REQUEST_METHOD"] == "POST"){
                                    ...
                                    if(!$cek_result){
                                        ...
                                        if($cek_result->num_rows > 0){
                                            ...
                                            $sql_insert = "insert into produk(nama,size,bahan,harga,image) values('$nama','$size','$bahan','$harga','$filename')";
